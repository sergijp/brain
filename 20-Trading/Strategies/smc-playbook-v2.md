...
> ⚠️ **2026-04-22 — STRUCTURAL UPDATE:** цей playbook залишається **master / shared rules** (risk, scoring, gates, journal). Усі 7 моделей входу винесено у 3 окремі торгові системи для чистої attribution бектесту:
> - [[20-Trading/Strategies/ts-1-reversal-at-poi]] — Моделі 1, 2, 5
> - [[20-Trading/Strategies/ts-2-session-manipulation]] — Моделі 4, 6, 7
> - [[20-Trading/Strategies/ts-3-inner-fvg-sniper]] — Модель 3
>
> **Live status:** [[20-Trading/Strategies/ts-tracker]]. Тестування одна за одною.
...
- **Style scope:** semi-scalp + intraday only (no overnight holds)
- **Рахунок:** $10,000
- **Базовий ризик:** 1% = $100/трейд
- **Daily DD limit:** 3% ($300) → стоп торгівлі до завтра
- **RR мінімум:** 1:3 (hard gate), ціль 1:5+
- **Формула лоту (EURUSD):** `Lot = $100 / (risk_pips × $10)`

### ⏱️ Intraday hold rules (універсально для всіх ТС)
- **EOD close:** усі позиції закриваються до **21:00 UTC** (NY close), незалежно від статусу TP
- **Session-bound:** позиція має відпрацювати у тій сесії, де відкрита (London або NY)
- **Якщо TP3 не дотягнуто за 30 хв до EOD** → manual close на market
- **Manual close також:** якщо setup-теза ламається (протилежний 15m BOS до TP1)
...
| Inner FVG present | +1 |
| RR ≥ 1:5 до ліквідності (бонус — 1:3 це вже мінімум) | +2 |
| **Макс** | **10** |
...
5. ☐ RR ≥ 1:3 до ліквідності? (hard min)
...
- [[20-Trading/Strategies/ts-tracker]] — статус 3 ТС (split з 2026-04-22)
- [[20-Trading/Strategies/ts-1-reversal-at-poi]] — Моделі 1, 2, 5
- [[20-Trading/Strategies/ts-2-session-manipulation]] — Моделі 4, 6, 7
- [[20-Trading/Strategies/ts-3-inner-fvg-sniper]] — Модель 3

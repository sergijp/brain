...
# USDJPY: Top-Down Analysis — 12.05.2026

> Час аналізу: 05:15 UTC / 08:15 EEST (субагент). До London KZ — ~45 хв.
...
- **Entry Zone:** `157.376 – 157.422` (H1 Demand OB, після M15 CHoCH)
- **Stop Loss:** `157.340` (нижче sweep low) — **~7-8 pts**
- **TP1:** `157.656` — RR ~3.2 (H1 fresh high)
...
**Коментар:** Найсильніша пара дня за momentum — double sweep W завершено, BOS D підтверджений, H4 чистий bullish trend. Сетап: Pullback до H1 OB 157.376-157.422 → LONG. Best session: NY KZ (12:00-14:00 UTC) та London KZ (06:00-08:00 UTC). Перевірити ForexFactory на JPY high-impact events. TP2 1:7 природно виходить через тісний SL. **Найчистіший momentum setup.**

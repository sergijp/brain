...
# EURUSD: TDA Full Protocol — 28.04.2026
...
Долар США демонструє аномальну силу, що робить шорт-позиції по EURUSD пріоритетними. Ринок шукає ліквідність нижче 1.1680.

## 🚀 Основний план (Primary Scenario)
- **Сценарій:** Retest H1 POI (1.1720) -> MSS на M5 -> Short.
- **Entry Zone:** 1.1715 – 1.1725
- **Stop Loss:** 1.1735 (за локальний хай).
- **Take Profit:** TP1: 1.1680 (BSL), TP2: 1.1650 (H4 Target).
- **Ризик:** 0.5% (Lot: 0.33).

## ⚠️ Альтернативний план (Alternative Scenario)
- **Сценарій:** Закріплення тілом H1 вище 1.1740 скасовує ведмежий сценарій.
- **Дія:** Перегляд на користь лонгу до 1.1780.
---
**🥊 Debate Convergence:** Касандра наполягла на зниженні ризику до 0.5% через перекупленість DXY. План узгоджено.
